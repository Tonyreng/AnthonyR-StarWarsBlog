        ...
        <div className="card-body">
          <div className="row">
            {props.title1 && (
              ...
              >
                <h2 className="mb-3" style={{ color: "#FF1744" }}>
                  {props.title1}
                </h2>
            ...
            {props.title10 && (
              <div
                className={`col flex-column ${props.title11 && "border-end"}`}
                style={{ minHeight: "250px" }}
              >
                <h2 className="mb-3" style={{ color: "#FF1744" }}>
                  {props.title10}
            ...
            {props.title11 && (
              <div
                className={`col flex-column ${props.title12 && "border-end"}`}
                style={{ minHeight: "250px" }}
              >
                <h2 className="mb-3" style={{ color: "#FF1744" }}>
                  {props.title11}
            ...
            {props.title12 && (
              <div
                className={`col flex-column ${props.title13 && "border-end"}`}
                style={{ minHeight: "250px" }}
              >
                <h2 className="mb-3" style={{ color: "#FF1744" }}>
                  {props.title12}
                </h2>
                <span>{props.data12}</span>
              </div>
            )}
            {props.title13 && (
              <div
                className={`col flex-column ${props.title14 && "border-end"}`}
                style={{ minHeight: "250px" }}
              >
                <h2 className="mb-3" style={{ color: "#FF1744" }}>
                  {props.title13}
                </h2>
                <span>{props.data13}</span>
              </div>
            )}
            {props.title14 && (
